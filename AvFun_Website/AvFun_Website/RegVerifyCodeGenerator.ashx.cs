...
namespace AvFun_Website
{
    ...
    /// </summary>
    public class RegVerifyCodeGenerator : IHttpHandler, IRequiresSessionState
    {
        int intLength = 5;              //长度
        public static string strIdentify = "RegVerifyCode"; //随机字串存储键值，以便存储到Session中
        public RegVerifyCodeGenerator()
        {
        }
